        ...
        if(password=="aryan")
        {
            ...
            do{
                ...
                else if(command=="play music")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    ShellExecute(NULL,"open","music.mp3",NULL, NULL, SW_NORMAL);
                }
                ...
                else if(command=="open C language book")
                {
                    cout<<"opening C language book"<<endl;
                    string phrase = "opening C language book";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    ShellExecute(NULL,"open","Let Us C.pdf",NULL, NULL, SW_NORMAL);
                }
